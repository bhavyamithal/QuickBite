      ...
      <div className='flex gap-4 overflow-auto scrollbar-hide' ref={listRef}>
        {categoryList && categoryList.map((category, index) => (
          <Link href={'?category=' + category.slug} key={index}
           ...
           gap-2 border p-3 rounded-xl min-w-28 bg-gray-200 hover:shadow-lg transition-all
           hover:border-primary hover:bg-orange-100
           cursor-pointer group
           ${selectedCategory == category.slug && 'text-primary border-primary bg-orange-100'}
           `}>
