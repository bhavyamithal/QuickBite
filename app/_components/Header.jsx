...
function Header() {
  ...
  return (
    <div className='flex justify-between items-center
     '>
      <Link href={'/'}> <Image src='/main_logo2.png' alt='logo'
        width={150}
        height={150} />
      </Link>
      ...
      {isSignedIn ?
        ...
        : <div className='flex gap-5'>
          <SignInButton mode='modal'>
            <Button className="text-orange-600 hover:text-orange-500 transition-all" variant="outline">Login</Button>
          </SignInButton>
          <SignUpButton mode='redirect'>
            <Button className="bg-orange-600 hover:bg-orange-500 transition-all">Sign Up</Button>
          </SignUpButton>
