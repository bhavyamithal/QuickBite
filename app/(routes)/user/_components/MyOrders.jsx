...
function MyOrders() {
  ...
  return (
    <div>
        <h2 className='font-bold text-lg my-4'>My Orders</h2>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
            {orderList.map((order,index)=>(
                <div className='p-3 border rounded-lg flex flex-col gap-3'>
                    ...
                    <h2 className='flex text-sm justify-between'>Address: <span className='text-right'>{order.address}, {order.zipCode}</span></h2>
                        ...
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent>
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <hr></hr>
                                    <h2 className='font-bold justify-between text-md mt-2'>Total Order Amount (Including Taxes): <span className='text-right'>₹{(order.orderAmount).toFixed(2)}</span> </h2>
                                </div>
                            </AccordionContent>
                        </AccordionItem>
                        </Accordion>
